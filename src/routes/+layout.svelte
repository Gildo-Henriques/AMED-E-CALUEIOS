...
<header class="flex 2xl:px-44 px-8 lg:px-32 lg:py-5 py-4 items-center justify-between">
    <!-- LOGO -->
 <img src="./lgo.png" alt="" class="lg:h-10 h-8">
 <!-- NAVBAR -->
  <!-- btn -->
  <Navbar />
  <a href="" class="bg-black text-white rounded-md px-5 py-3 hidden lg:flex">CONTACTE-NOS</a>
</header>
<slot></slot>
<!-- Footer -->
